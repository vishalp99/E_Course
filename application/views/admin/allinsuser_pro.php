				...
				<div class="profile-header-content">
					<!-- BEGIN profile-header-img -->
						<div class="profile-header-img">
							<img src="<?php echo base_url('resources/shared/instituteimg/insuser/'.$uinfo[0]->profilepic) ?>" alt="" />
						</div>
						<!-- END profile-header-img -->
						<!-- BEGIN profile-header-info -->
						<div class="profile-header-info" style="margin-top: 40px">
							<h4 ><?php echo $uinfo[0]->username; ?></h4>
						</div>
						...
						<ul class="profile-info-list d-none d-xl-block">
							<li class="title">PERSONAL INFORMATION OF STUDENT</li>
								<li>
									...
									<div class="value"><?php echo $uinfo[0]->instituteuserid; ?></div>
								</li>
								<li>
									<div class="field">Institute Name</div>
									<div class="value"><?php echo $uinfo[0]->institutename; ?></div>
								</li>
								<li>
									<div class="field">Email_Id</div>
									<div class="value"><?php echo $uinfo[0]->email; ?></div>
								</li>
								<li>
									<div class="field">Contact_NO</div>
									<div class="value">+91&nbsp;<?php echo $uinfo[0]->mobilenumber; ?></div>
								</li>
								<li>
									<div class="field">Description</div>
									<div class="value"><?php echo $uinfo[0]->description; ?></div>
								</li>
								<li>
									<div class="field">Full Name</div>
									<div class="value"><?php echo $uinfo[0]->fullname; ?></div>
								</li>								
								<li>
									<div class="field">Added Date</div>
									<div class="value"><?php echo $uinfo[0]->addeddate; ?> 
									</div>
								</li>													
								<li>
									<div class="field">Level</div>
									<div class="value"><?php echo $uinfo[0]->level; ?></div>
								</li>									
						</ul>
