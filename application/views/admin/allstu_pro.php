				...
				<div class="profile-header-content">
					<!-- BEGIN profile-header-img -->
						<div class="profile-header-img">
							<img src="<?php echo base_url('resources/shared/images/'.$sinfo[0]->profilepic) ?>" alt="" />
						</div>
						...
						<ul class="profile-info-list d-none d-xl-block">
							<li class="title">PERSONAL INFORMATION OF STUDENT</li>
								<li>
									...
									<div class="value"><?php echo $sinfo[0]->studentid; ?></div>
								</li>
								<li>
									<div class="field">Full Name</div>
									<div class="value"><?php echo $sinfo[0]->fullname; ?></div>
								</li>
								<li>
									<div class="field">Email_Id</div>
									<div class="value"><?php echo $sinfo[0]->emailid; ?></div>
								</li>
								<li>
									<div class="field">Contact_NO</div>
									<div class="value">+91&nbsp;<?php echo $sinfo[0]->mobilenumber; ?></div>
								</li>
								<li>
									<div class="field">City Name</div>
									<div class="value"><?php echo $sinfo[0]->cityname; ?></div>
								</li>
								<li>
									<div class="field">Bio</div>
									<div class="value"><?php echo $sinfo[0]->bio; ?></div>
								</li>								
								<li>
									<div class="field">Registration Date</div>
									<div class="value"><?php echo $sinfo[0]->regdatetime; ?> 
									</div>
								</li>
						</ul>
