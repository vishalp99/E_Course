		...
		<div id="content" class="app-content">		    	
            <div class="row">
            	...
            	foreach ($stu as $i1)
            	{
                 	?>
		            	<div class="col-xl-3">
							<a href="<?php echo site_url("admin/Student/loadStudent/".$i1->studentid) ?>" class="widget-card dynamic text-center">
								<div class="widget-card-cover" style="background-image: url(<?php echo base_url('resources/admin/'); ?>assets/img/login-cover.jpg);">
									<div class="cover-bg"></div>
								</div>
								<div class="widget-card-content">
									<div class="m-b-10 m-t-30">
										<img src="<?php echo base_url('resources/shared/images/'.$i1->profilepic); ?>" width="80px" height="80px" class="img-circle" alt="" />
									</div>
									<h4 class="widget-title widget-title-inverse"><?php echo $i1->username; ?></h4>
									<div class="widget-desc widget-desc-inverse m-b-15"><?php echo $i1->emailid; ?></div>
								</div>
