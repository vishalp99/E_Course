                    ...
                    <div id="post-content" class="col-md-12 col-sm-12 single-course">
                         <div class="big-title">
                            <h2 class="related-title">
                                <span><?php echo $linfo->resourcetitle ?></span>
                            </h2>
                        </div>
                            <?php 
                        ...
                        <div class="post-media clearfix">
                            ...
                            <video class="videoplayer" controls preload="none" poster="upload/video.jpg" style="background-image: url('<?php echo base_url('resources/institute/') ?>upload/video.jpg'); width: 100%; height: 100%;background-size: cover;">
                        ...
                        else if($linfo->resourcetype==1)
                        {
                           ...
                           <?php 
                        } else if($linfo->resourcetype==3)
                        {
                            ?>
                            <div class="post-media clearfix">                        
                            <object data="<?php echo base_url("resources/shared/institutepdf/$linfo->resourceurl"); ?>"></object>
                    </div>
                           <?php 
                        }
                      ...
                      ?>
                        ...
                        <div class="course-single-desc clearfix">
                            ...
                            <p>
                                <?php echo $linfo->resourcedescription; ?>.
                            </p>
                                                    ...
                                                    <li class="media">
                                                        <div class="comment">
                                                            ...
                                                            <div class="clearfix text-right">
                                                                <a href="<?php echo site_url("institute/Resources/blockquestion/$q->questionid/$linfo->resourceid") ?>" class="btn btn-primary">Block</a>
                                                            </div>
                                                        </div>
                                                   ...
                                                   ?>
                                                    ...
                                                    <li class="media">
                                                        <div class="comment">
                                                            ...
                                                            <div class="media-body">
                                                                <strong class="text-success"><?php echo "demo" ?></strong>
                                                                <span class="text-muted">
                                                        ...
                                                        <div class="clearfix text-right">
                                                                <a href="<?php echo site_url("institute/Resources/blockmsg/$m->questionstudentpostid/$linfo->resourceid") ?>" class="btn btn-primary">Block</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <?php 
           ...
           <!--                 <div class="fade" id="leave_ans">-->
                            <div class="clearfix">
                                ...
                                <div class="contact_form">
                                    <form class="row" method="post" action="<?php echo site_url("institute/Resources/addanswer/$q->questionid/$linfo->resourceid") ?>">
                                        <div class="col-md-12 col-sm-12">
