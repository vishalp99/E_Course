...
<head>
    ...
    <title>Ecourse | All Requests</title>
                                        ...
                                        <ul class="bbp-forums">
                                            <li class="bbp-header">
                                                <ul class="forum-titles">
                                                    <li class="bbp-forum-info">Panding Requests</li>

                                                    <li class="bbp-forum-topic-count hidden-xs">Deny</li>
                                                    <li class="bbp-forum-topic-count hidden-xs">Allow</li>
                                                    <li></li>
                                                    <li></li>
                                             ...
                                             <li class="bbp-body">       
                                                <ul class="forum type-forum status-publish hentry loop-item-0 odd bbp-forum-status-open bbp-forum-visibility-publish">
                                                    ...
                                                    <li class="bbp-forum-topic-count">
                                                        ...
                                                        <a href="<?php echo site_url("institute/Accessreq/denyreq/$s->studentid/$s->classid") ?>" class="btn btn-primary">Deny</a>
                                                    </li>

                                                    <li class="bbp-forum-topic-count">
                                                        <a href="<?php echo site_url("institute/Accessreq/allowestudent/$s->studentid/$s->classid") ?>" class="btn btn-primary">Allow</a>
                                                    </li>
