...
<head>
    ...
    <title>Ecourse | All Classes</title>
                            ...
                            <div class="post-media entry">
                                ...
                                <div class="magnifier">
                                    <div class="shop-bottom clearfix">
                                        <a href="<?php echo site_url("institute/Crtclass/loadeditclass/".$c->classid) ?>" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="<?php echo site_url("institute/Crtclass/deleteclass/".$c->classid) ?>" title="delete"><i class="fa fa-trash"></i></a>
