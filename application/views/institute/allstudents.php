                               ...
                               <div class="member-desc clearfix">
                                   <ul>
                                       ...
                                       <li><a href="<?php echo site_url("institute/Crtclass/loadallclass") ?>">Classes</a></li>
                                        ...
                                        <li class="active"><a href="<?php echo site_url("institute/InsLogin/loadstudents/")?>">All Students</a></li>
                                    </ul><!-- end ul -l -->
                                    <hr>
                                </div><!-- end team-desc -->
                            </div><!-- end team-member -->
                                        ...
                                        <ul class="bbp-forums">
                                            <li class="bbp-header">
                                                <ul class="forum-titles">
                                                    <li class="bbp-forum-info">Students</li>
                                                    <li class="bbp-forum-topic-count hidden-xs">Status</li>
                                                    <li class="bbp-forum-topic-count hidden-xs">Added By</li>
                                                </ul>
                                            </li><!-- .bbp-header -->
                                            <?php
                                             ...
                                             <li class="bbp-body">       
                                                <ul class="forum type-forum status-publish hentry loop-item-0 odd bbp-forum-status-open bbp-forum-visibility-publish">
                                                    <li class="bbp-forum-info">
                                                        ...
                                                        <div class="bbp-forum-content"><?php echo $s->emailid ?></div>
                                                    </li>
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="<?php echo site_url("institute/Accessreq/blockstudent/$s->studentid") ?>" class="btn btn-primary">Block</a>
                                                    <?php
                                                    } 
                                                    else{
                                                    ?>

                                                        <a href="<?php echo site_url("institute/Accessreq/unblockstudent/$s->studentid") ?>" class="btn btn-primary">Unblock</a>
                                                    <?php
                                                    }
                                                    ?>
                                                        
                                                    </li>
                                                    <li class="bbp-forum-topic-count hidden-xs"><?php if($s->addedby=="0")
                                                    {
                                                      echo "Request";
                                                    } 
                                                    else{
