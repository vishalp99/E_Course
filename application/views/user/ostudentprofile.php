                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="clearfix">
                                            <div class="avatar-author">
                                                <a href="author.html">
                                                    <img alt="" src="<?php echo base_url('resources/shared/images/'.$stu->profilepic) ?>" class="img-responsive">
                                                </a>
                                            </div>
                                            <div class="author-title desc">
                                                <h4><?php echo $stu->username ?></h4>
                    ...
                    <div id="sidebar1" class="col-md-8 col-sm-12">
                        <div class="widget clearfix">
                            <div class="member-profile">
                                <div class="big-title">
                                    <h2 class="related-title">
                                        <span>About <?php echo $stu->username ?></span>            
                                        </h2>
                                        <br>
                                        <ul>
                                            <li>
                                                <div><label disabled>Username</label></div>
                                                <div>&nbsp;<?php echo $stu->username ?></div>
                                            </li>
                                            <hr>
                                            <li>
                                                <div><label disabled>Mail ID</label></div>
                                                <div>
                                                &nbsp;<?php echo $stu->emailid ?></div>
                                            </li>
                                            <hr>
                                            <li>
                                                <div><label disabled>Bio</label></div>
                                                <div><p>&nbsp;<?php echo $stu->bio ?></p></div>
                                            </li>
                                        </ul>
                                </div><!-- end big-title -->
