            ...
            <div class="container">
                <div class="row">
                    <div id="post-content" class="col-md-12 col-sm-12">
                        <div class="notfound">
                            <h2>Error!</h2> 
                            <p>Sorry, Your account has been block.Ecourse think you are violating the terms and conditions. <br>Apply for get account back on<b>ecourselearning99@gmail.com</b>.<br>
                            <a href="<?php echo site_url("user/Home") ?>"><button class="button button--rayen" data-text="Welcome">Back to Home</button></a>
                       </div>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->
